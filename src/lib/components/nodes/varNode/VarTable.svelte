			...
			>
				...
				<Table.Cell>
					<DropdownMenu.Root>
						...
						>
							<DropdownMenu.RadioGroup bind:value={item.type}>
								<DropdownMenu.RadioItem value="let"
									>let</DropdownMenu.RadioItem
								>
								<DropdownMenu.RadioItem value="var"
									>var</DropdownMenu.RadioItem
								>
								<DropdownMenu.RadioItem value="const"
									>const</DropdownMenu.RadioItem
								>
